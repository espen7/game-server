...
public class RpcRequest implements Serializable {
    ...
    public RpcRequest(String serviceName, String methodName, Object[] parameters) {
        this(serviceName, methodName, parameters, 5000, 3, null);
    }
    ...
    public RpcRequest(String serviceName, String methodName, Object[] parameters,
        ...
        this.callContext = callContext != null ? callContext : 
                          RpcCallContext.newInternalContext("unknown-service");
    }
    ...
    public RpcCallContext getCallContext() { return callContext; }
